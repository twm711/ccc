...
var (
	...
	ErrMonitorTargetNotActive = errors.New("monitor target call is not active")
	ErrCoachTimeout           = errors.New("coach session timed out")
	ErrMissingMonitorTarget   = errors.New("monitor target is required")
)
